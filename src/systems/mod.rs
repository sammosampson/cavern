...
pub fn build_start_schedule() -> Schedule {
    Schedule::builder()
        ...
        .flush()
        .add_thread_local(editing::editor_graph_entity_deletion_system())
        .add_thread_local(world::mark_added_entity_system())
...
pub fn build_play_schedule() -> Schedule {
    Schedule::builder()
        ...
        .add_thread_local(editing::editor_event_handling_system())
        .flush()
